...
bool isaMUstring (const char *sequence, int size)
{
  for (int i=0; i<size; i++)
    {
      if ((sequence [i] == 'A')||(sequence [i] == 'B')||(sequence [i]== 'C')||(sequence [i]== 'D')||(sequence [i]== 'E')||(sequence [i]== 'F')||(sequence [i]== 'G')||(sequence [i]== 'H')||(sequence [i]== 'J')||(sequence [i]== 'K')||(sequence [i]== 'L')||(sequence [i]== 'N')||(sequence [i]== 'O')||(sequence [i]== 'P')||(sequence [i]== 'Q')||(sequence [i]== 'R')||(sequence [i]== 'S')||(sequence [i]== 'T')||(sequence [i]== 'V')||(sequence [i]== 'W')||(sequence [i]== 'X')||(sequence [i]== 'Y')||(sequence [i]== 'Z')||(sequence [i]== 'a')||(sequence [i]== 'b')||(sequence [i]== 'c')||(sequence [i]== 'd')||(sequence [i]== 'e')||(sequence [i]== 'f')||(sequence [i]== 'g')||(sequence [i]== 'h')||(sequence [i]== 'i')||(sequence [i]== 'j')||(sequence [i]== 'k')||(sequence [i]== 'm')||(sequence [i]== 'l')||(sequence [i]== 'n')||(sequence [i]== 'o')||(sequence [i]== 'p')||(sequence [i]== 'q')||(sequence [i]== 'r')||(sequence [i]== 's')||(sequence [i]== 't')||(sequence [i]== 'u')||(sequence [i]== 'v')||(sequence [i]== 'w')||(sequence [i]== 'x')||(sequence [i]== 'y')||(sequence [i]== 'z')||(sequence [i]== '1')||(sequence [i]== '2')||(sequence [i]== '3')||(sequence [i]== '4')||(sequence [i]== '5')||(sequence [i]== '6')||(sequence [i]== '7')||(sequence [i]== '8')||(sequence [i]== '9')||(sequence [i]== '0'))
	return false;	
    }
  return true;
}
