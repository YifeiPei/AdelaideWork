...
<html>
 <head>
  <title>Recording last name</title>
...
<?php 
 ...
 if (filter_var($_POST["studentid1"], FILTER_VALIDATE_INT) == FALSE) {
      echo "invalid format";
    }else{

      $name2 = $_POST["studentid2"] . "_" . $_POST["lastname"]; 
      echo $name2;
   }
 ?>
  ...
  $.jRecorder(
  { 
   host : '../MCID/acceptfile.php?filename=<?php echo $name2; ?>',
