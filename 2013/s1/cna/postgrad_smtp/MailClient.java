...
public class MailClient extends Frame {
	...
	private TextField keywordField = new TextField ("", 40);
	private Label commentLabel = new Label ("Comment:");
	private TextField commentField = new TextField ("", 40);
	
	private Label messageLabel = new Label("Message:");
	private TextArea messageText = new TextArea(10, 40);
	
	// try to do error checking
	private Panel messagePanel = new Panel(new BorderLayout());
	...
	public MailClient() {
		...
		// additional headers
		Panel keywordPanel = new Panel (new BorderLayout ());
		Panel commentPanel = new Panel (new BorderLayout ());
		...
		// additional headers
		fieldPanel.add(keywordPanel);
		fieldPanel.add(commentPanel);
	...
	class SendListener implements ActionListener {
		public void actionPerformed(ActionEvent event) {
			...
			try {
				ESMTPConnection connection = new ESMTPConnection(envelope);
				...
				JOptionPane.showMessageDialog (messagePanel , "You typed something wrong for sending the email.\r\nPlease have a check and re-type your commands.", "Incorrect commands", JOptionPane.WARNING_MESSAGE);
			}
