...
public class MapDraw extends JPanel{
	...
	public MapDraw(Map m, Graph g){
		...
		this.setBounds(247, 13, 900, 690); //size of the map 1300x750
	...
	public void paintComponent(Graphics g)
	{
		...
		if(map.getRobot().getRobotOrientation() == 90){
			g2d.drawImage(robotNORTH,(int)(map.getRobot().getRobotLocation().getX()-2),
					(int)((map.getHeight() - map.getRobot().getRobotLocation().getY())-2), 3, 4, null);
		}
		else if(map.getRobot().getRobotOrientation() == 270){
			g2d.drawImage(robotSOUTH,(int)(map.getRobot().getRobotLocation().getX()-2),
					(int)((map.getHeight() - map.getRobot().getRobotLocation().getY())-2), 3, 4, null);
		}
		else if(map.getRobot().getRobotOrientation() == 0){
			g2d.drawImage(robotEAST,(int)(map.getRobot().getRobotLocation().getX()-3),
					(int)((map.getHeight() - map.getRobot().getRobotLocation().getY())-3), 4, 3, null);
		}
		...
		if(showAI){
			...
			for(Vertex v: vertices){
				...
				g2d.drawRect((int)(v.getCoordinate().getX()),
						(int)((map.getHeight() - v.getCoordinate().getY())), 1, 1);
				g2d.fillRect((int)(v.getCoordinate().getX()),
						(int)((map.getHeight() - v.getCoordinate().getY())), 1, 1);
			}

			/*
			ArrayList<Vertex> solution = graph.getSolution();
			g2d.setColor(Color.red);
			for(int i = 0; i < solution.size()-1; i++){
				...
				g2d.drawLine((int)e.fromVertex().getCoordinate().getX(), (int)(map.getHeight() - e.fromVertex().getCoordinate().getY()),
						(int)e.toVertex().getCoordinate().getX(), (int)(map.getHeight() - e.toVertex().getCoordinate().getY()));
				g2d.drawRect((int)(v1.getCoordinate().getX()),
						(int)((map.getHeight() - v1.getCoordinate().getY())), 1, 1);
				g2d.fillRect((int)(v1.getCoordinate().getX()),
						(int)((map.getHeight() - v1.getCoordinate().getY())), 1, 1);
				g2d.drawRect((int)(v2.getCoordinate().getX()),
						(int)((map.getHeight() - v2.getCoordinate().getY())), 1, 1);
				g2d.fillRect((int)(v2.getCoordinate().getX()),
						(int)((map.getHeight() - v2.getCoordinate().getY())), 1, 1);
			}
			*/
		}
