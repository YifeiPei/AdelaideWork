...
\item Edge
\item Vertex
\item CollisionResult
\item TestOfCollisionTest
\item AStarComparator
\item MyInt
\item ArtificialIntelligenceFSM
\item Action
\end{itemize}
...
\item MapDraw
\item GUICommands
\item BatteryInfoTask
\item SensorRequestTask
\item FileListener
\item BatteryDisplay
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.4]{controllerFSM.png}
\caption{The ControllerFSM diagram}
\label{Figure 3}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.4]{hostSideCommsUnit.png}
\caption{The host side diagram}
\label{Figure 3}
\end{figure}
     
\begin{figure}[H]
\centering
\includegraphics[scale=0.4]{AIUnit.png}
\caption{The AIUnit diagram}
\label{Figure 4}
\end{figure}
